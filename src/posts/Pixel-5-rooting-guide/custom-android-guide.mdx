...
Android Rooting Guide for 2022. I thought it'd be useful to compile some common methods and termiology used when rooting an Android phone.
This guide is geared twards Pixel users, but I'm sure that non-Pixel users could draw some insight from this post regardless.
